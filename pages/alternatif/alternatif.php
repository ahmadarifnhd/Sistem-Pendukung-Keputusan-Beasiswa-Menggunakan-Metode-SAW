...
$users = tampilData("SELECT username FROM data_user WHERE role = 'user'");
...
if (isset($_POST['simpan'])) {
  ...
  // maksimal input data alternatif  
  if ($isi[0] >= 20) {
    echo "<script>
              alert('Data Alternatif Hanya Bisa Input Maksimal 20 Data');
           </script>";
  } else {
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select class="form-control select2" style="width: 100%;" name="alternatif" required>
